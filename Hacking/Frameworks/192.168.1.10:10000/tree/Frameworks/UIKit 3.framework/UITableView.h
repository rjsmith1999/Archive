...
@property (getter=_defaultSectionContentMarginWidth, nonatomic, readonly) double defaultSectionContentMarginWidth;
...
- (double)_defaultSectionContentMarginWidth;
...
- (void)_cnui_adjustContentInset:(struct UIEdgeInsets { double x1; double x2; double x3; double x4; })arg1;
