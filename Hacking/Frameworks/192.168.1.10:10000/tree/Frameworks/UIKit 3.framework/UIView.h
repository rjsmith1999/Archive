...
- (struct CGSize { double x1; double x2; })_calculatedSystemLayoutSizeFittingSize:(struct CGSize { double x1; double x2; })arg1 withHorizontalFittingPriority:(float)arg2 verticalFittingPriority:(float)arg3 hasIntentionallyCollapsedHeight:(bool*)arg4 shouldFlush:(bool)arg5;
...
- (id)_accessibilityCheckForAllowedModalView:(struct CGPoint { double x1; double x2; })arg1 event:(id)arg2;
- (id)_accessibilityChildVendingParent;
- (id)_accessibilityCirclePathBasedOnBoundsWidth;
- (void)_accessibilityFinalize;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })_accessibilityFrameForView:(id)arg1;
...
- (id)_superAccessibilityHitTest:(struct CGPoint { double x1; double x2; })arg1 withEvent:(id)arg2;
