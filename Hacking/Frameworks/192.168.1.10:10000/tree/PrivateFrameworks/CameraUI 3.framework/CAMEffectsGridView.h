...
- (void)dealloc;
- (long long)filterTypeForPoint:(struct CGPoint { double x1; double x2; })arg1;
- (id)filterTypes;
- (bool)isBlackAndWhite;
- (bool)isSquare;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })rectForFilterType:(long long)arg1;
