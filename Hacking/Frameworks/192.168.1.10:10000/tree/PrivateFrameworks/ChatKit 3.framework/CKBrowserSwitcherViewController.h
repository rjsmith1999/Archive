...
@interface CKBrowserSwitcherViewController : UIViewController <CKBrowserSelectionControllerDelegate, CKBrowserSwitcherScrollPreventerDelegate, CKBrowserTransitionCoordinatorDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UIGestureRecognizerDelegate, UIScrollViewAccessibilityDelegate, UIScrollViewDelegate> {
