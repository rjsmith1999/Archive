...
- (struct CGSize { double x1; double x2; })stickerSizeScaledWithInitialSize:(struct CGSize { double x1; double x2; })arg1 imageScale:(double)arg2 userScale:(double)arg3 rectifiedScreenScale:(double)arg4;
