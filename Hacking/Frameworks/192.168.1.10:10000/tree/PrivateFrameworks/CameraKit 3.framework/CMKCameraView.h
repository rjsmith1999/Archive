...
@interface CMKCameraView : UIView <CMKBottomBarDelegate, CMKModeDialDataSource, CMKStillImageCaptureRequestDelegate, CMKTimerButtonDelegate, CMKTopBarDelegate, CMKZoomSliderDelegate, PLCameraControllerDelegate, PLCameraPanoramaViewDelegate, UIAccelerometerDelegate, UIGestureRecognizerDelegate> {
...
- (void)_accessibilityDetectFaces:(bool)arg1 controller:(id)arg2 completionBlock:(id /* block */)arg3;
...
- (void)_detectLuminance:(struct opaqueCMSampleBuffer { }*)arg1;
