...
- (void)setEdgeInsets:(struct VKEdgeInsets { double x1; double x2; double x3; double x4; })arg1 duration:(double)arg2 timingFunction:(id)arg3 completionHandler:(id /* block */)arg4;
...
- (void)transitionToTracking:(bool)arg1 mapMode:(long long)arg2 pounceCompletionHandler:(id /* block */)arg3;
...
- (struct { double x1; double x2; double x3; double x4; })_axBoundsOfElements;
- (struct { double x1; double x2; })_axConvertScreenPointToCoordinate:(struct CGPoint { double x1; double x2; })arg1;
- (id)_axDirectionsManager;
- (id)_axElementManager;
- (id)_axElements;
- (bool)_axElementsInvalidForVisibleBounds;
- (void)_axInitializeTimers;
- (struct CGPoint { double x1; double x2; })_axIntersectionBetweenRoad:(id)arg1 andOtherRoad:(id)arg2;
...
- (struct { double x1; double x2; double x3; double x4; })accessibilityBounds;
- (id)accessibilityCalloutAnnotationView;
- (struct { double x1; double x2; })accessibilityCenter;
- (void)accessibilityClearVisibleAXBoundsFrame;
- (id)accessibilityContainerElements;
- (struct CGPoint { double x1; double x2; })accessibilityConvertCoordinateToWindow:(struct { double x1; double x2; })arg1;
- (void)accessibilityDecreaseTrackingDetail;
- (float)accessibilityDistance:(struct CGPoint { double x1; double x2; })arg1 forAngle:(float)arg2 toRoad:(id)arg3 withElement:(id)arg4;
- (float)accessibilityDistanceToEndOfRoad:(struct CGPoint { double x1; double x2; })arg1 forAngle:(float)arg2 withElement:(id)arg3;
...
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })accessibilityPositionFrameForElement:(struct { double x1; double x2; double x3; double x4; })arg1;
- (float)accessibilityRealDistanceBetweenPoint:(struct CGPoint { double x1; double x2; })arg1 screenPoint2:(struct CGPoint { double x1; double x2; })arg2;
- (bool)accessibilityScroll:(long long)arg1;
- (bool)accessibilityTileLoadingComplete;
- (id)accessibilityTourStatus;
- (unsigned long long)accessibilityTraits;
- (id)accessibilityUpcomingRoadsForPoint:(struct CGPoint { double x1; double x2; })arg1 forAngle:(float)arg2 withElement:(id)arg3;
- (bool)accessibilityViewBoundsContainsPathPoint:(struct CGPoint { double x1; double x2; })arg1;
- (struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })accessibilityVisibleAXViewBounds;
- (double)accessibilityYaw;
- (void)accessibilityZoom:(bool)arg1 point:(struct CGPoint { double x1; double x2; })arg2;
