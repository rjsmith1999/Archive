...
@interface NSObject <CAAnimatableValue, CARenderValue, CKDParsedObject, NSObject, PQLResultSetInitializer> {
    Class  isa;
}
...
@property (nonatomic, retain) NSArray *accessibilitySpriteKitChildElements;
...
// Image: /System/Library/AccessibilityBundles/SpriteKit.axbundle/SpriteKit

- (id)accessibilityMakeSpriteKitChildElementsIfNeeded;
- (id)accessibilitySpriteKitChildElements;
- (void)setAccessibilitySpriteKitChildElements:(id)arg1;
...
- (void)_accessibilitySetTextSelection:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1;
- (void)_accessibilityShare;
- (void)_accessibilityUnderline;
- (long long)_emojiCompare:(id)arg1;
- (void)accessibilityClearInternalData;

// Image: /System/Library/AccessibilityBundles/WeatherFoundation.axbundle/WeatherFoundation

+ (id)_accessibilityWeatherStringForKey:(long long)arg1;
